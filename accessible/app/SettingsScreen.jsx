  ...
  return (
    <View style={{ gap: 16 }}>
      ...
      <View
        style={styles.group}
        accessible
        accessibilityLabel="Grupo de Acessibilidade Tátil"
      >
        <Text style={styles.groupTitle}>Acessibilidade Tátil</Text>

        <View style={styles.row}>
          <Text style={styles.label}>Alvos de toque grande</Text>
          ...
          <BigButton
            ...
            accessibilityHint="Alterna a sensibilidade tátil para alvos de toque maior."
          />
        </View>
      </View>
